...
const VerificarCodigo = ({ navigation, route }) => {
    const rota = "http://192.168.12.137:3000"; // Certifique-se de que esta URL está correta
    ...
    return (
        <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
            ...
            <TouchableOpacity style={styles.linkButton} onPress={() => navigation.navigate('EsqueçeuSenha')}>
